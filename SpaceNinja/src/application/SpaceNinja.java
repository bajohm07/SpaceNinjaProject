...
public class SpaceNinja extends Application {
	...
	static final int EXPLOSION_STEPS = 15;
		...
		private void setup() {
			...
			player = new Ninja(WIDTH / 2, HEIGHT - PLAYER_SIZE, PLAYER_SIZE, PLAYER);
			score = 0;
		...
		public class Ninja {
			...
			public boolean colide(Ninja other) {
		...
		public class Shot {
			...
			public boolean colide(Ninja Ninja) {
		...
		invader newinvader() {
			return new invader(50 + rand.nextInt(WIDTH - 100), 0, PLAYER_SIZE, invadersImg[rand.nextInt(invadersImg.length)]);
		}
